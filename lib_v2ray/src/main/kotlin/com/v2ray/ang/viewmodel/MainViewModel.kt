...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun testAllTcping() {
        ...
        getApplication<Application>().toast(R.string.connection_test_testing)
...
//            }.show()
    ...
    fun copyAssets(assets: AssetManager) {
        val extFolder = Utils.userAssetPath(getApplication<Application>())
        ...
        override fun onReceive(ctx: Context?, intent: Intent?) {
            when (intent?.getIntExtra("key", 0)) {
                ...
                AppConfig.MSG_STATE_START_SUCCESS -> {
                    getApplication<Application>().toast(R.string.toast_services_success)
                    isRunning.value = true
                }

                AppConfig.MSG_STATE_START_FAILURE -> {
                    getApplication<Application>().toast(R.string.toast_services_failure)
                    isRunning.value = false
                }
