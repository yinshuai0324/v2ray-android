...
class MainRecyclerAdapter(val activity: V2RayMainActivity) : RecyclerView.Adapter<MainRecyclerAdapter.BaseViewHolder>()
    ...
    private var mActivity: V2RayMainActivity = activity
...
//            }
            ...
            holder.itemMainBinding.layoutRemove.setOnClickListener {
                if (guid != mainStorage?.decodeString(MmkvManager.KEY_SELECTED_SERVER)) {
                    ...
                    AngApplication.application.toast(R.string.toast_action_not_allowed)
                }
            }
